...
* добавить в этот README автоматический `setup_kali.sh` (полный скрипт) в репозиторий рядом с файлом;
* сделать краткую шпаргалку `cheatsheet.md` с командами по фазам;
* перевести README на английский.

Готов внести правки по твоим пожеланиям.
